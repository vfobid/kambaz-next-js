...
export default function TOC() {
 ...
 return (
   <Nav variant="pills">
     ...
     <NavItem>
       <NavLink href="https://github.com/vfobid/kambaz-next-js">
         My GitHub
       </NavLink>
     </NavItem>
     <NavItem>
       <NavLink href="https://github.com/vfobid/kambaz-node-server-app">
         Server GitHub
       </NavLink>
     </NavItem>
     <NavItem>
       <NavLink href="https://kambaz-node-server-app-t6hj.onrender.com">
         Server Root
       </NavLink>
     </NavItem>
   </Nav>
